...
(function (a) {
    a.fn.quicksand = function (b, c) {
        var e = {duration: 750, easing: "swing", attribute: "data-id", adjustHeight: "false", useScaling: true, enhancement: function (a) {
        }, selector: "> *", dx: 0, dy: 0};
        a.extend(e, c);
        ...
        return this.each(function (c) {
            ...
            p.each(function (b) {
                ...
                if (c.length) {
                    if (!e.useScaling) {
                        h.push({element: a(this), animation: {top: c.offset().top - t.top, left: c.offset().left - t.left, opacity: 1}})
                    } else {
                        h.push({element: a(this), animation: {top: c.offset().top - t.top, left: c.offset().left - t.left, opacity: 1, scale: "1.0"}})
                    }
                } else {
                    if (!e.useScaling) {
