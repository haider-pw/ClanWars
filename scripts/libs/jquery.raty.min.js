...
//            if (d.opt.path.substring(d.opt.path.length - 1, d.opt.path.length) != "http://xhtml.webtemplatemasters.com/") {
//                d.opt.path += "http://xhtml.webtemplatemasters.com/";
//            }
...
//        }
    ...
    b.fn.raty.defaults = {cancel: false, cancelHint: "cancel this rating!", cancelPlace: "left", click: undefined, half: false, halfShow: true, hints: ["bad", "poor", "regular", "good", "gorgeous"], iconRange: undefined, mouseover: undefined, noRatedMsg: "not rated yet", number: 5, precision: false, round: {down: 0.25, full: 0.6, up: 0.76}, readOnly: false, score: undefined, scoreName: "score", single: false, size: 16, space: true, target: undefined, targetFormat: "{score}", targetKeep: false, targetText: "", targetType: "hint", width: undefined};
})(jQuery);
